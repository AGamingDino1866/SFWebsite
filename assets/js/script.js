...
const injectNavyTheme = () => {
  ...
  style.textContent = `
    ...
    .hero-card,.auth-hero,.contact-hero,.status-hero,.eligibility-hero,.ai-banner{background:linear-gradient(135deg,rgba(52,76,132,.76),rgba(52,76,132,.38)),url("assets/education-hero.png") center/cover!important;color:#ffffff!important}
